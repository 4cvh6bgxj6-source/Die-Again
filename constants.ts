...
export const LEVELS: LevelData[] = [
  ...
  createLevel(4, "Venti di Sventura", "Impossible", [
    { pos: { x: 0, y: 650 }, size: { x: 150, y: 50 }, color: NEON_PURPLE, type: 'wall' },
    { pos: { x: 250, y: 550 }, size: { x: 150, y: 30 }, color: NEON_PURPLE, type: 'wall' },
    { pos: { x: 280, y: 530 }, size: { x: 30, y: 20 }, color: '#ff0000', type: 'trap' },
    { pos: { x: 450, y: 450 }, size: { x: 150, y: 30 }, color: NEON_PURPLE, type: 'wall' },
    { pos: { x: 500, y: 430 }, size: { x: 40, y: 20 }, color: '#ff0000', type: 'trap' },
    { pos: { x: 650, y: 550 }, size: { x: 150, y: 30 }, color: NEON_PURPLE, type: 'wall' },
    { pos: { x: 700, y: 530 }, size: { x: 30, y: 20 }, color: '#ff0000', type: 'trap' },
